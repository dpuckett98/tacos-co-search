...
class Hardware:
	...
	def __init__(self, num_PEs, num_RFs_per_PE, size_RF, off_chip_bandwidth, on_chip_bandwidth, max_sram_size, tiling_generator, double_buffering=False):
		...
		self.max_sram_size = max_sram_size
		self.double_buffering = double_buffering
		self.tiling_generator = tiling_generator
	
	# gets a layer object from build_models.py, returns the tiling parameters [dataflow, t_i, t_w, t_d, c_i, t_w, t_d]
	def get_tiling_parameters(self, layer):
		return self.tiling_generator(self.num_PEs, self.num_RFs_per_PE, self.size_RF, self.off_chip_bandwidth, self.on_chip_bandwidth, self.max_sram_size, layer)
	
	def print(self):
		print("Hardware Description:")
		print("Num PEs:", self.num_PEs)
		...
		print("Max SRAM Size:", self.max_sram_size)
		print("Double buffering:", self.double_buffering)
	
	def get_string(self):
		descrip = "Hardware Description:\n"
		descrip += "Num PEs: " + str(self.num_PEs) + "\n"
		...
		descrip += "Max SRAM Size: " + str(self.max_sram_size) + "\n"
		descrip += "Double buffering " + str(self.double_buffering) + "\n"
		return descrip
