...
def estimate_performance(hardware, layer, params):
	compute_bound_cycles = compute_bound_estimate(hardware, layer, params)
...
def test():
	...
	params = ['rows', 'B-Stationary', 1072, 134, 134, 10, 1, 10]
	
	layer = layer_set.unique_layers[2][0]
